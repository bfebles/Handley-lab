...
for i in *.snpEFF.ann.vcf; do
     ...
     java -jar /home/binita/snpEff/SnpSift.jar extractFields ${F}.snpsift.filtered.vcf CHROM POS REF ALT VARTYPE QUAL FILTER DP AF SB "ANN[0].GENE" "EFF[0].EFFECT" "EFF[0].IMPACT" "EFF[0].BIOTYPE" > ${F}.snpsift.tsv;
